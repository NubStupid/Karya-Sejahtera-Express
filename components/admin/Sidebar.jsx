    ...
    return (
        <>
            <div className="bg-sky-300 w-60 p-4 text-white text-xl font-semibold">
                ...
                <h3><Link href="/admin/products" className={path == "/admin/products" ? "text-black" : ""}>Catalog</Link></h3>
                ...
                <h3><Link href="/admin/chat" className={path == "/admin/chat" ? "text-black" : ""}>Chat</Link></h3>
